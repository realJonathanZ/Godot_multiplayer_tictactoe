# This test script has an example of:
...
# 4. as tested: 2 different godot instances connecting through the same server.
#    -- with their different identity, room joining destination and customized player name.
